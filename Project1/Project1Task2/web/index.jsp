    ...
    <body class="index">
        ...
        <div class="calc">
            <form action="BigCalc" method="GET">
                <div class="numbers">
                    <input class="number1" type="text" name ="firstNum" placeholder="Please input a number" required autofocus/>
                    <input class="number2" type="text" name ="secondNum" placeholder="Please input a number" required autofocus/>
                ...
                <input class="submit" type="submit" value="Compute"/></div>
            </form>
        </div>
    </body>
</html>
